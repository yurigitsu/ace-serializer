...
require "ace_serializer/version"

Gem::Specification.new do |spec|
  spec.name    = "ace-serializer"
  spec.version = AceSerializer::VERSION
  ...
  spec.files         = Dir["CHANGELOG.md", "LICENSE", "README.md", "ace-serializer.gemspec", "lib/**/*"]
  spec.bindir        = "bin"
  spec.executables   = []
